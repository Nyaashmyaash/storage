...
@Getter
@NoArgsConstructor
public class NotFoundOrderStorageException extends RuntimeException implements ExceptionInfo {

    private static final String DEFAULT_ERROR_CODE = "cant.find.order.storage.by.order.id";
